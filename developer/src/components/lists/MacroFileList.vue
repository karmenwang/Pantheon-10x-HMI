<template>
	<div class="component">
		<v-toolbar>
			...
			<v-btn large depressed class="hidden-sm-and-down mr-3" :disabled="uiFrozen" @click="showNewFile = true">
				<v-icon class="mr-1">mdi-file-plus</v-icon> {{ $t('button.newFile.caption') }}
			</v-btn>
			<v-btn large depressed class="hidden-sm-and-down mr-3" :disabled="uiFrozen" @click="showNewDirectory = true">
